...
<script>
    ...
    // Posicionar la cámara en el punto 0,0,50 mirando al centro (0,0,0)
    camera.position.set(0, 0, 50);
    camera.lookAt(0, 0, 0);

    // Crear un planeta debajo del punto 0,0,0
    ...
    planet.position.set(0, -20, 0);  // Planeta debajo del origen
    scene.add(planet);
    ...
    controls.maxPolarAngle = Math.PI / 2;  // Limita a 90 grados hacia arriba
    controls.minPolarAngle = 0;            // Limita a 0 grados hacia abajo
    controls.screenSpacePanning = false;   // Deshabilita el panning
    controls.maxDistance = 100;            // Limita el zoom
    controls.minDistance = 20;             // Limita el zoom mínimo
